...
import com.example.ibm_t440p.ureminder.Activity.Activity.Adapter.Gao2Adapter;
...
public class Gao2 extends AppCompatActivity {
    Toolbar toolbar;
    RecyclerView recyclerView;
    ArrayList<SanPham> arrayList = new ArrayList<>() ;
    Gao2Adapter gao2Adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gao2Adapter = new Gao2Adapter(this,arrayList);
        recyclerView.setAdapter(gao2Adapter);
    ...
    class SanPhamTask extends AsyncTask<Void,Void,ArrayList<SanPham>>
    {
        ...
        protected void onPostExecute(ArrayList<SanPham> quanen) {
            ...
            gao2Adapter.notifyDataSetChanged();
        }
        ...
        protected ArrayList<SanPham> doInBackground(Void... params) {
            ...
            try
            {
                URL url = new URL("http://ugao-server.herokuapp.com/api/producttypes/5adcd0818fb2bc32b0bfc6f3");
