...
public class Gao1 extends AppCompatActivity {
    Toolbar toolbar;
    RecyclerView recyclerView;
    ArrayList<SanPham> arrayList = new ArrayList<>() ;
    Gao1Adapter gao1Adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gao1);
        AnhXa();

        LinearLayoutManager layoutManager = new LinearLayoutManager(this,LinearLayoutManager.VERTICAL,false);
        recyclerView.setLayoutManager(layoutManager);
        gao1Adapter = new Gao1Adapter(this,arrayList);
        recyclerView.setAdapter(gao1Adapter);
    ...
    class SanPhamTask extends AsyncTask<Void,Void,ArrayList<SanPham>>
    {
        ...
        protected void onPostExecute(ArrayList<SanPham> quanen) {
            ...
            gao1Adapter.notifyDataSetChanged();
        }
