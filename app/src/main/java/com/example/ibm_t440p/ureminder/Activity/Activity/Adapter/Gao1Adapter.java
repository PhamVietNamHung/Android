...
import com.example.ibm_t440p.ureminder.Activity.Activity.Activity.Gao1;
...
public class Gao1Adapter extends RecyclerView.Adapter<Gao1Adapter.DataViewHolder> {
    ...
    public Gao1Adapter(Context context, ArrayList<SanPham> arraysanpham) {
    ...
    @Override
    public Gao1Adapter.DataViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView;
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_gao1, parent, false);

        Gao1Adapter.DataViewHolder dataViewHolder = new Gao1Adapter.DataViewHolder(itemView,context,this.arraysanpham);
        return dataViewHolder;
    }


    @Override
    public void onBindViewHolder(Gao1Adapter.DataViewHolder holder, int position) {
