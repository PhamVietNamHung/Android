...
public class Gao3Adapter extends RecyclerView.Adapter<Gao3Adapter.DataViewHolder> {
    ...
    public Gao3Adapter(Context context, ArrayList<SanPham> arraysanpham) {
    ...
    @Override
    public Gao3Adapter.DataViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView;
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_gao1, parent, false);

        Gao3Adapter.DataViewHolder dataViewHolder = new Gao3Adapter.DataViewHolder(itemView,context,this.arraysanpham);
        return dataViewHolder;
    }


    @Override
    public void onBindViewHolder(Gao3Adapter.DataViewHolder holder, int position) {
